...
class ModelTest < Minitest::Test
  ...
  class BasicValidation < BasicModel
    validates :phone_number, phonejack: { country: proc{ |record| record.country } }
  end

  class ValidationWithTypes < BasicModel
    validates :phone_number, phonejack: { country: proc{ |record| record.country }, types: [:toll_free] }
  end

  class AllowBlankOption < BasicModel
    validates :phone_number, phonejack: { country: proc{ |record| record.country } }, allow_blank: true
  end
