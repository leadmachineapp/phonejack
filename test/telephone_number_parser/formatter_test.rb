...
module TelephoneNumberParser
  class FormatterTest < Minitest::Test
    ...
    def test_national_number_if_valid
      formatter = TelephoneNumberParser::Formatter.new(@valid_phone_obj)
    ...
    def test_national_number_if_invalid
      formatter = TelephoneNumberParser::Formatter.new(@invalid_phone_obj)
    ...
    def test_e164_number_if_invalid
      ...
      formatter = TelephoneNumberParser::Formatter.new(phone_obj)
